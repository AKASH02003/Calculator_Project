...
label = Label(window, textvariable=equation_label,font=("Arial", 20),bg="light blue",width=25,height=2)
label.pack()
...
clear= Button(frame,text="clear",height=4,width = 9,
              font= 35,command= clear_button)
